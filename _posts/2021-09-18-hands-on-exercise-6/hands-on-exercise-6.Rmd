...
## 1.0 Overview
This week, we'll be looking at spatial weights and their applications. The recommended reading for this exercise is a little lengthy, but it's a very comprehensive explanation + walkthrough of spatial weights in R, so do [check it out](https://spatialanalysis.github.io/lab_tutorials/Distance_Based_Spatial_Weights.html) if you have time!

<center>
![](images/recommendedreading.png)
</center>
