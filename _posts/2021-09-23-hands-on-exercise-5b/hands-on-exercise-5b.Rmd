...
"So, let's use Singapore's national boundaries!" You might say, remembering how we used `CostalOutline` for our previous analysis. However, take a look at the map below:
...
As such, it would be wiser for us to narrow down the study area - such as using the more geographically appropriate planning area.
