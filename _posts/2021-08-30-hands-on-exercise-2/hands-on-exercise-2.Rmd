...
## 3.1 Importing polygon feature data in shapefile format {.tabset}
...
## 3.2 Importing polyline feature data in shapefile form {.tabset}

### st_read

### glimpse

## 3.3 Importing GIS data in kml format {.tabset}
...
## 4.1 Importing aspatial data {.tabset}

### read_csv

### glimpse

## 4.2 Converting aspatial data {.tabset}
...
We've just started on our Geospatial Analytics Journey - walk with me as we dive deeper the coming weeks! `r emo::ji("hugging_face")` `r emo::ji("sparkling_heart")` `r emo::ji("sparkles")`
