...
tm_shape(sg_sf) +
  tm_borders(alpha = 0.5) +
  tmap_options(check.and.fix = TRUE) +
# listings_2019 is a Spatial object now! Recall our pre-processing in Section 3.1
tm_shape(listings_2019) +
  tm_dots(col = 'room_type', size = 0.05, title="Room Type" ,alpha=0.6,
          palette = c("#FF5A5F", "#00A699","#FFFF00"))
