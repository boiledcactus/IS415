...
description: |
  Today's Adventure:Global and Local Measures of Spatial Autocorrelation! We'll learn how to compute Global Spatial Autocorrelation (GSA) and Local Indicator of Spatial Association (LISA) statistics, as well as detect hot spot and/or cold spots with the spdep package `r emo::ji("smile")` 
author:
  - name: Megan Sim
