...
description: |
  This is a dummy blog post for testing out the various ins and outs of a Distill blog. In this hands-on exercise, I learned how to handle geospatial data in R by using the sf package.
author:
  - name: Megan Sim
